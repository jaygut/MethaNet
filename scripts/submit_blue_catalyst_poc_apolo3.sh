...
export BC_SOURCE_SUBSET_PATH="${BC_SOURCE_SUBSET_PATH:-}"
...
export BC_EMBED_COHORT_MODE="${BC_EMBED_COHORT_MODE:-strict_run}"
export BC_EXCLUDE_COASSEMBLY="${BC_EXCLUDE_COASSEMBLY:-1}"
...
echo "DEBUG BC_SOURCE_SUBSET_PATH=${BC_SOURCE_SUBSET_PATH}"
echo "DEBUG BC_EMBED_COHORT_MODE=${BC_EMBED_COHORT_MODE}"
echo "DEBUG BC_EXCLUDE_COASSEMBLY=${BC_EXCLUDE_COASSEMBLY}"
