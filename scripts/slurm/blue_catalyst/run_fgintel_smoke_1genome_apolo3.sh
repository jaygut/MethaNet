...
INNER_GPU_GRES="${INNER_GPU_GRES:-gpu:1}"
BC_DEVICE="${BC_DEVICE:-auto}"
BC_ESM2_MODEL="${BC_ESM2_MODEL:-facebook/esm2_t12_35M_UR50D}"
BC_ESM2_BATCH="${BC_ESM2_BATCH:-4}"
...
echo "[INFO] INNER gpu=${INNER_GPU_GRES} device=${BC_DEVICE} esm2_model=${BC_ESM2_MODEL} esm2_batch=${BC_ESM2_BATCH}"
...
EXPORTS+=",BC_DEVICE=$BC_DEVICE"
EXPORTS+=",BC_ESM2_MODEL=$BC_ESM2_MODEL"
EXPORTS+=",BC_ESM2_BATCH=$BC_ESM2_BATCH"
